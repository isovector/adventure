mrequire "src/engine/polygon"
mrequire "src/engine/sheet"
mrequire "src/engine/serialize"
...
vim:cmd("editor", "new-room",   function(id)
                                    ...
                                    local room = Room.new(id, "game/static/newroom.png")
                                    room.directory = "game/rooms/" .. id
                                    room.in_memory = true
                                    room.new_img_path = "game/static/newroom.png"
                                    Room.change(id)
                                end)
